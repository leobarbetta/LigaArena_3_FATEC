<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Despesas.aspx.cs" Inherits="Pages_Financeiro_Despesas" %>
        ...
        <div class="container destaque">
            ...
            <section class="conteudo-site">
                ...
                <section class="campos">
                    ...
                    <br />
                    <asp:TextBox ID="txtTipoDespesa" runat="server" />
                    <br />
                    <asp:TextBox ID="txtValorDespesa" class="monetario" runat="server" />
                    <br />
