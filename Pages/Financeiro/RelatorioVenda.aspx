<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelatorioVenda.aspx.cs" Inherits="Pages_Administrativo_RelatorioVenda" %>
    ...
    <form id="form2" runat="server">
        ...
        <div class="container destaque">
            ...
            <section class="conteudo-site">
                ...
                <asp:GridView ID="gdvRelatorioVendas" runat="server" AutoGenerateColumns="False" CssClass="table table-hover" Font-Size="Small" CellSpacing="10">
                    <Columns>
                        <asp:BoundField DataField="PED_DATAHORA" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Data Venda" DataFormatString="{0:d}">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>

                        <asp:BoundField DataField="PED_VALORTOTAL" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Total por venda">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
