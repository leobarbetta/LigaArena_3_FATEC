<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RelatorioFuncionarios.aspx.cs" Inherits="Pages_Administrativo_RelatorioFuncionarios" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container destaque">
            ...
            <section class="conteudo-site">
                ...
                <asp:GridView ID="gdvFuncionario" runat="server" AutoGenerateColumns="False" CssClass="table table-hover" OnRowCommand="gdvClientes_RowCommand" Font-Size="Small" CellSpacing="10">
                    <Columns>
                        ...
                        <asp:BoundField DataField="PES_NUMEROREGISTRO" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Nº Registro">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PES_TELEFONE" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Telefone">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                        <asp:BoundField DataField="PES_ATIVO" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Status">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Editar" HeaderStyle-ForeColor="WhiteSmoke" HeaderStyle-BackColor="WindowFrame" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEditar" runat="server" CommandName="Editar" CssClass="but but-warning but-rc but-shadow but-size1" Text="Editar" href="AlterarFuncionario.aspx"
                                    CommandArgument='<%# Bind("PES_CODIGO")%>' />
                            </ItemTemplate>
