<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecebePedido.aspx.cs" Inherits="Pages_Administrativo_RecebePedido" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container destaque">
            ...
            <section class="conteudo-site">
                ...
                <asp:GridView ID="gdvRecebePedido" runat="server" AutoGenerateColumns="False" CssClass="table table-hover" OnRowCommand="gdvRecebePedido_RowCommand" Font-Size="Small" CellSpacing="10">
                    <Columns>
                        ...
                        <asp:BoundField DataField="PED_NUMEROMESA" HeaderStyle-ForeColor="WhiteSmoke" HeaderText="Mesa">
                            <HeaderStyle BackColor="WindowFrame" CssClass="text-center" />
                            <ControlStyle BackColor="WindowFrame" BorderColor="#000066" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Ativar/Desativar" HeaderStyle-ForeColor="WhiteSmoke" HeaderStyle-BackColor="WindowFrame" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnAD" runat="server" CommandName="status" CssClass="but but-success but-rc but-shadow but-size1" Text="Finalizar pedido"
                                    CommandArgument='<%# Bind("PED_CODIGO")%>' />
                            </ItemTemplate>
